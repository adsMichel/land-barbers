...
@section('title', 'Barbers - Produtos')
...
<div class="container-fluid">
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <a href="{{ route('product.create') }}" class="btn btn-primary float-sm-right button-theme"><i class="fas fa-fw fa-user-plus"></i> Novo Produto</a>
        </div>
    </div>
</div>
@stop
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Quantidade" name="quantidade" value="{{\Request::get('quantidade')}}">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group">
                            ...
                            <tbody>
                                ...
                                <tr class=" {{ $item->status === 'Pendente' ? 'table-danger' : '' }}">
                                    ...
                                    <td class="align-middle">
                                        <div class="btn-group">
                                            <a href="{{ route('product.edit', $item->id) }}" data-toggle="tooltip" title="Editar Produto"><button class="btn-sm btn-primary mr-1"><i class="fas fa-edit"></i></button></a>
                                            <form action="{{ route('product.destroy', $item->id) }}" method="POST" style="display: inline">
                                                @method('DELETE')
                                                @csrf
                                                <button class="btn-sm btn-danger" data-toggle="tooltip" title="Excluir Produto">
